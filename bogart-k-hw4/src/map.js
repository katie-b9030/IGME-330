...
const accessToken = "pk.eyJ1Ijoia2xiLTkwMzAiLCJhIjoiY2x1aGIwdGR3MmJoaTJqcXQ1M3BtMmpoZCJ9.PXOrUMSCPkw0vGX3VWk6gw";
let map;
...
const initMap = (center) => {
	...
	addMarker(geojson.features[0], "poi");
};
...
const addMarker = (feature, className, clickHandler) => {
	...
	const html = `<b>${feature.properties.title}</b><p>${feature.properties.address}</p><p><b>Phone:</b> ${feature.properties.phone}</p>`;
